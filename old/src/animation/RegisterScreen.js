  ...
  return (
    <KeyboardAwareScrollView style={{flex:1}}  >
      ...
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.contentText}>Sign up to get started</Text>
      </View>
      ...
      <View style={styles.mxhContainer}>
        <TouchableOpacity style={styles.pressMXH}>
          ...
          <Text style={styles.textMXH}>Continue with Google</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.footerContainer}>
        <Text style={styles.footerText}>Already have an account? </Text>
        <TouchableOpacity style={styles.footerPress}>
          <Text style={[styles.footerText, { color: 'blue', fontWeight: 'bold' }]}>Login</Text>
        </TouchableOpacity>
      </View>
      </View>
