...
import Welcome from '../components/Read';
...
const Play = () => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name="Home">{props => <Mains />}</Stack.Screen>
      <Stack.Screen name="Detail">
        {props => <DetailScreen navigation={props.navigation} />}
      </Stack.Screen>
      <Stack.Screen name="Search">
        {props => <SearchScreen navigation={props.navigation} />}
      </Stack.Screen>
...
const AppNavigator = () => {
  ...
  return <>{isLogin == false ? <Users /> : <Home />}</>;
};
